...
2.  Create a new **Project** (e.g., "Sbali").
...
- "Connection Refused": Check `REDIS_HOST`. If using Docker networking, use the container name (e.g., `sbali-redis` or `redis`). If external, use IP.
