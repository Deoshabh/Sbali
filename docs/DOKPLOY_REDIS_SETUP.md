...
In the **sbali-backend service** (NOT the new Valkey service), update or add these environment variables:
...
2. Click **"Redeploy"** on the sbali-backend service
