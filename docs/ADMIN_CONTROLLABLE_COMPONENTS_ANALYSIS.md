...
```javascript
{
  footer: {
    ...
    socialLinks: [
      {
        platform: "facebook",
        url: "https://facebook.com/sbali",
        enabled: true
      },
      {
        platform: "twitter",
        url: "https://twitter.com/sbali",
        enabled: true
      },
      {
        platform: "instagram",
        url: "https://instagram.com/sbali",
        enabled: true
      }
    ]
  }
...
{
  legal: {
    copyrightText: "© 2026 Sbali. All rights reserved.",
    links: [
...
```javascript
{
  aboutPage: {
    meta: {
      title: "About Us - Sbali",
      description: "Learn about Sbali..."
    },
    header: {
      title: "About Sbali",
    ...
    story: {
      title: "Our Story",
      content: `Sbali was born from a simple belief: everyone deserves access to quality footwear...` // Rich text
    },
    values: [
      {
        id: 1,
...
```javascript
{
  faqPage: {
    meta: {
      title: "Frequently Asked Questions - Sbali",
...
```javascript
{
  shippingPage: {
    meta: {
      title: "Shipping Information - Sbali",
...
```javascript
{
  returnsPage: {
    meta: {
      title: "Return & Refund Policy - Sbali",
