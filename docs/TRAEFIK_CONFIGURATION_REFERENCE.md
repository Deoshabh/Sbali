...
if ($request_method = 'OPTIONS') {
    add_header 'Access-Control-Allow-Origin' 'https://sbali.in' always;
...
accesscontrolalloworiginlist=https://sbali.in,https://www.sbali.in
...
# Should show:
# sbali-backend  | healthy
# sbali-frontend | healthy
# traefik        | healthy
```
