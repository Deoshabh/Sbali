...
Completed a comprehensive review of the backend sync logic for the Firebase login endpoint (`api.sbali.in/api/v1/auth/firebase-login`) which was returning a **400 Bad Request** error.
