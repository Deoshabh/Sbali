          ...
          <div className="space-y-8 text-primary-700">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Welcome to Sbali (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;). These Terms of Service (&quot;Terms&quot;) govern your 
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                property of Sbali or its licensors and is protected by copyright, trademark, and other 
            ...
            <section className="border-t border-primary-200 pt-8">
              ...
              <div className="bg-primary-50 rounded-lg p-6 space-y-2">
                <p><strong>Email:</strong> support@sbali.in</p>
                <p><strong>Website:</strong> www.sbali.in</p>
              </div>
            </section>
          </div>
        </div>
